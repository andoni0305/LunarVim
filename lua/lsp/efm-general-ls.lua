...
local luaFormat = {
  formatCommand = "lua-format -i --indent-width=2 --no-keep-simple-function-one-line --column-limit=120",
  formatStdin = true
}
...
require"lspconfig".efm.setup {
  ...
  filetypes = {
    "lua", "python", "javascriptreact", "javascript", "typescriptreact", "typescript", "sh", "html", "css", "scss",
    "less", "json", "yaml", "markdown", "vue"
  },
  settings = {
    rootMarkers = {".git/"},
    languages = {
